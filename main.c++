...
void loop() {
    ...
    string nearest_place=Nearest(lat,lng);
    // Insert data into the SQL database
    char query[256];
    sprintf(query, "INSERT INTO realtime_data (device_id, temperature, humidity, latitude, longitude, place) VALUES ('%s', '%f', '%f', '%f', '%f')", 
            device_id.c_str(), temperature, humidity, lat, lng,nearest_place);
